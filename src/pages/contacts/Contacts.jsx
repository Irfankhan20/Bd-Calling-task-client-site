...
const Contacts = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <h2 className="text-2xl font-bold text-center pb-10">Support Session</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-20">
        ...
        <motion.div
          ...
          className="bg-[#e0f2f2] rounded-xl shadow-xl "
        >
          <div className="bg-[#e0f2f2] p-10 rounded-xl shadow-xl">
